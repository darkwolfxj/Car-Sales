...
export const rootReducer = (state = initState, action) => {
    switch (action.type) {
        case "ADD_FEATURE":
            ...
            {    ...state, additionalPrice: [...state.additionalPrice, action.obj.price], car: { ...state.car, features: [...state.car.features, action.obj] } 
            }
        case "REMOVE_FEATURE":
            ...
            return {
                ...state, additionalPrice: [ ...state.additionalPrice, -action.obj.price ], car: { ...state.car, features: [...state.car.features.filter(i =>( i.id !== action.obj.id))  ] }
            }
        default:
            return state               
    }
